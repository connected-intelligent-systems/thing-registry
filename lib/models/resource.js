...
const { KeycloakHost, KeycloakRealm, ResourceClientId, ResourceClientSecret } = require("../utils/keycloak")
...
async function createAffordance (name, user, attributes) {
  return create(name, user, ResourceTypes.Affordance, attributes, DefaultAffordanceScopes)
}

...
function createHttpCredentials (credentials, target) {
  const results = target.security.map(security => {
    const securityDefinition = target.securityDefinitions[security]
